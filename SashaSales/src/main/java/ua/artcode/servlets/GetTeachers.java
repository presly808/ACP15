...
@WebServlet(urlPatterns = {"/getteachers"})
public class GetTeachers extends HttpServlet {

    private static final Logger LOG = Logger.getLogger(GetTeachers.class);
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (teacherlist == null && teacherlist.size() == 0) {
            ...
            req.getRequestDispatcher("/WEB-INF/pages/get-teachers.jsp").forward(req, resp);
        }
    }
